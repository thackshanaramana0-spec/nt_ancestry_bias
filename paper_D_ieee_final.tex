...
set of reference alleles regardless of the donor's precise ancestry. Sirugo et al.\ reported that 86.5\% of participants in the GWAS Catalog were
...
is attenuated by high within-population scoring variance ($\sigma{\approx}2.23$),
which reflects that reference preference is primarily driven by local sequence
context. The population-scale consequences of this per-variant gap are
...
reference-agnostic training are required, not merely a larger training cohort.
